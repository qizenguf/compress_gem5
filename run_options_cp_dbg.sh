...
GEM5_DIR=/media/fd538cb5-97ec-46b1-829f-6aaae01875e3/qizeng/gem5                         # Install location of gem5
...
$GEM5_DIR/build/ALPHA/gem5.opt --debug-flags=Cache --debug-file=$OUTPUT_DIR/$BENCHMARK/options_$5/cache.out --outdir=$OUTPUT_DIR/$BENCHMARK/options_$5 $GEM5_DIR/configs/example/spec06_config_single.py --benchmark=$BENCHMARK --restore-with-cpu=detailed -s 1000000000 --cpu-clock=3GHz --mem-size=4GB --mem-channels=2 --mem-type=DDR3_1600_8x8 --caches --l1i_size=32kB --l1i_assoc=8 --l1d_size=32kB --l1d_assoc=8 --l2cache --l2_size=256kB --l2_assoc=8 --l3cache --l3_size=4MB --l3_assoc=32 --l3_tags=$5 --checkpoint-dir=/media/fd538cb5-97ec-46b1-829f-6aaae01875e3/qizeng/$BENCHMARK_CODE/run/run_base_ref_my-alpha.0000/m5out/ --checkpoint-restore=$WARM_LEN --at-instruction --maxinsts=$RUN_LEN --warmup-insts=1000000000
